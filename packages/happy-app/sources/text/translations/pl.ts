...
export const pl: TranslationStructure = {
    ...
    hearth: {
        hearthside: 'Przy kominku',
    },

    warden: {
        sectionTitle: 'Potrzebują Cię',
        gate: 'Decyzja',
        routine: 'Rutyna',
        answered: 'Odpowiedziano',
        withdrawn: 'Wycofano',
        supersededBy: ({ id }: { id: string }) => `Zastąpione przez ${id}`,
        reference: 'Odnośnik',
        ...
        pipFresh: 'Warden czuwa',
        pipStale: 'Warden zaczyna milczeć',
        pipDead: ({ time }: { time: string }) => `Warden ucichł — ostatnio widziany ${time}`,
        pipUnknown: 'brak jeszcze wiadomości od Wardena',
    },
