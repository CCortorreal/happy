...
export const es: TranslationStructure = {
    ...
    warden: {
        ...
        answered: 'Respondido',
        withdrawn: 'Retirado',
        supersededBy: ({ id }: { id: string }) => `Reemplazado por ${id}`,
        ...
        pipFresh: 'el Warden está despierto',
        pipStale: 'el Warden se está quedando en silencio',
        pipDead: ({ time }: { time: string }) => `el Warden se quedó en silencio — visto por última vez ${time}`,
        pipUnknown: 'todavía sin noticias del Warden',
    },

    sessionsList: {
        searchPlaceholder: 'Buscar lanes y tarjetas…',
        searchEmpty: ({ query }: { query: string }) => `Ninguna lane o tarjeta coincide con “${query}”`,
    },
