...
export const it: TranslationStructure = {
    ...
    warden: {
        ...
        answered: 'Risposto',
        withdrawn: 'Ritirato',
        supersededBy: ({ id }: { id: string }) => `Sostituito da ${id}`,
        ...
        pipFresh: 'il Warden è sveglio',
        pipStale: 'il Warden sta diventando silenzioso',
        pipDead: ({ time }: { time: string }) => `il Warden è rimasto in silenzio — visto l'ultima volta ${time}`,
        pipUnknown: 'ancora nessuna notizia dal Warden',
    },

    sessionsList: {
        searchPlaceholder: 'Cerca lane e schede…',
        searchEmpty: ({ query }: { query: string }) => `Nessuna lane o scheda corrisponde a “${query}”`,
    },
    ...
    worker: {
        ...
        idle: 'inattivo',
        warm: 'in memoria',
        stuck: ({ task, mins }: { task: string; mins: number }) => `bloccato su ${task} (${mins} min)`,
        vram: 'VRAM',
        unloaded: 'scaricato',
        lastTask: 'Ultima attività',
    },
